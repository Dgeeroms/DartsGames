...
/**
 * Class for GameType. Get the score ASAP from 301 to 0, BUT the dart leading to 0 must strike a Double field.
 ...
 */
class GT301() : GameType {
    override val description = "THREEHUNDREDANDONE"
